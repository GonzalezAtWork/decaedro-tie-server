...
<form name="form" id="form" method="post">
	...
	<fieldset id="groups">
		...
		<legend>Piso da Calçada</legend>
				
		<div align="center" class="field_line" style="padding-top:10px;">
			<span class="left_label">Novo Piso:</span>
		...
		<div style="padding-top:20px;">
			...
			<table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#005599">
				...
				<tr>
					<td width="30">&nbsp;</td>
					<td class="table_title">Nome do Piso</td>
				</tr>
				...
				<?php
					...
					foreach ($result as $row) {
						...
						$html .= '<input type="radio" name="pesquisa_id_piso_calcada" value="'.$row["id_piso_calcada"].'">';
						$html .= '</td>';
