...
<form name="pontosTipo" id="pontosTipo" method="post">
	...
	<fieldset id="groups">
		...
		<legend>Limites de Terrenos</legend>
		
		<div align="center" class="field_line" style="padding-top:10px;">
			<span class="left_label">Novo Limite:</span>
		...
		<div style="padding-top:20px;">
			...
			<table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#005599">
				...
				<tr>
					<td width="30">&nbsp;</td>
					<td class="table_title">Nome do Limite</td>
				</tr>
				...
				<?php
					...
					$query  = " select * from limiteTerreno";
					...
					foreach ($result as $row) {
						...
						$html .= '<input type="radio" name="pesquisa_id_limite_terreno" value="'.$row["id_limite_terreno"].'">';
						$html .= '</td>';
