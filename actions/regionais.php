...
<form name="form" id="form" method="post">
	...
	<fieldset id="groups">
		...
		<legend>Adm. Regionais</legend>
		
		<div align="center" class="field_line" style="padding-top:10px;">
			<span class="left_label">Adm. Regional:</span>
		...
		<div style="padding-top:20px;">
			...
			<table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#005599">
				...
				<tr>
					<td width="30">&nbsp;</td>
					<td class="table_title">Nome da Adm. Regional</td>
				</tr>
				...
				<?php
					...
					foreach ($result as $row) {
						...
						$html .= '<input type="radio" name="pesquisa_id_regional" value="'.$row["id_regional"].'">';
						$html .= '</td>';
