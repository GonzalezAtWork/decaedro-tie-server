...
<form name="form" id="form" method="post">
	...
	<fieldset id="groups">
		...
		<legend>Inclinacoes</legend>
		
		<div align="center" class="field_line" style="padding-top:10px;">
			<span class="left_label">Nova Inclinação:</span>
		...
		<div style="padding-top:20px;">
			...
			<table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#005599">
				...
				<tr>
					<td width="30">&nbsp;</td>
					<td class="table_title">Inclinação</td>
				</tr>
				...
				<?php
					...
					foreach ($result as $row) {
						...
						$html .= '<input type="radio" name="pesquisa_id_inclinacao" value="'.$row["id_inclinacao"].'">';
						$html .= '</td>';
