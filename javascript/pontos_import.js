		...
		$.ajax({
			...
			success: function(response) {if (!isJSON(response)) { return false };
				...
				if(response == '{"processado":"true"}'){
					message = 'Pontos de Parada incluídos!';
				}else{
					message = 'Erro na importação!';
				}
				str = '<h1 style="color:#005599;height:140px;line-height:140px;">' + message + '</h1>';
				TINY.box.show({html:str, autohide:4, close:true, animate:true, width:380, height:150, closejs:function(){location.href='home.php?action=pontos';} })
